...
From the plot we can see that hurricane happens mostly in the east coast.
...
From the summary we can see that the range of the data is very large.
...
The data of federal share has a similar distribution with the data of public assistance cost.
